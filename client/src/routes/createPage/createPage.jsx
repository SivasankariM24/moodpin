...
//   const navigate = useNavigate(); //when any cmponent renders, react expects a jsxx file, but we' re not returning any jsx (we're just navigating), so to prevent error, we use useEffect
...
//   // const [newBoard, setNewBoard] = useState(""); //this is for the new board creation
...
//       formData.append("textOptions", JSON.stringify(textOptions)); //this is in json format
